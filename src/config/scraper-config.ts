export const scraperConfig = {
  ...
  passlineHomeUrl: "https://home.passline.com",
  passlineEventsBaseUrl: "https://www.passline.com/eventos",
  passlineCountryBillboardUrl: "https://api.passline.com/v1/event/GetCountryByBillboardHome",
  requestsPerSecond: 1,
  retryAttempts: 3,
  timeoutMs: 15_000,
