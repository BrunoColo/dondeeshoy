...
export function ShareButton({
  ...
  if (variant === "icon") {
    return (
      <div ref={containerRef} className={cn("relative", className)}>
        ...
        {open && (
          <div
            className="absolute right-0 bottom-10 z-50 min-w-[160px] rounded-xl border border-white/[0.1] bg-[#0f0f1a]/95 backdrop-blur-xl shadow-2xl overflow-hidden"
  ...
  return (
    <div ref={containerRef} className={cn("relative inline-block", className)}>
      ...
      {open && (
        <div className="absolute left-0 bottom-10 z-50 min-w-[180px] rounded-xl border border-white/[0.1] bg-[#0f0f1a]/95 backdrop-blur-xl shadow-2xl overflow-hidden">
          <button
            type="button"
            onClick={handleWhatsapp}
